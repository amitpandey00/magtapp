...
import '../../data/services/gemini_translation_service.dart';
import '../../data/services/mock_translation_service.dart';

// Service provider - uses Gemini AI if API key is set, otherwise uses mock
...
class TranslationState {
  ...
  TranslationState copyWith({
    ...
    return TranslationState(
      ...
      error: error,
      savedTranslations: savedTranslations ?? this.savedTranslations,
...
class TranslationNotifier extends StateNotifier<TranslationState> {
  final dynamic
  _service; // Can be either GeminiTranslationService or MockTranslationService
  ...
  void _loadSupportedLanguages() {
    ...
    state = state.copyWith(
      ...
      sourceLanguage: languages.firstWhere((l) => l.code == 'en'),
      targetLanguage: languages.firstWhere((l) => l.code == 'es'),
    );
  }
  ...
  Future<void> translateText(String text) async {
    ...
    try {
      final translation = await _service.translateText(
        text,
  ...
  Future<void> translateBatch(List<String> texts) async {
    if (state.sourceLanguage == null || state.targetLanguage == null) {
      state = state.copyWith(
        error: 'Please select source and target languages',
      );
